...
parser.add_argument('-c', '--cuda', type=int, default=6)
...
# write to file
agg_table = pd.read_excel('/home/luckytiger/GNN/KDD_model/model_result/agg_result/2_layer_agg_result.xlsx')
agg_table.loc[agg_table.shape[0]] = {'type': args.type, 'rate': args.rate, 'attenuate': args.attenuate,
                                     ...
                                     'acc_on_test': test_rate_under_best_validate, 'acc_on_val': best_validate_rate,
                                     'loss_on_train': train_loss_under_best_validate}
agg_table = agg_table[
    ['type', 'rate', 'attenuate', 'drop', 'lr', 'epoch', 'acc_on_test', 'acc_on_val', 'loss_on_train']]
agg_table.to_excel('/home/luckytiger/GNN/KDD_model/model_result/agg_result/2_layer_agg_result.xlsx')
