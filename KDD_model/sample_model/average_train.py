...
# write to file
agg_table = pd.read_excel('/home/luckytiger/GNN/KDD_model/model_result/agg_result/average_result.xlsx')
for m in range(args.attenuate):
    attenuate_rate = attenuate_base * m
    for n in range(args.drop):
        drop_rate = drop_base * n
...
agg_table.to_excel('/home/luckytiger/GNN/KDD_model/model_result/agg_result/average_result.xlsx')
